...
# ── Better admin check ──
async def is_bot_admin_in_chat(client, chat_id, bot_id):
    """Check if bot has admin rights in a channel using multiple methods."""
    try:
        # Method 1: get_chat_member (standard)
